...
Const TGA_NULL:Int=0
Const TGA_MAP:Int=1
Const TGA_RGB:Int=2
Const TGA_MONO:Int=3
Const TGA_RLEMAP:Int=9
Const TGA_RLERGB:Int=10
Const TGA_RLEMONO:Int=11
Const TGA_COMPMAP:Int=32
Const TGA_COMPMAP4:Int=33
...
Function makeargb:Int(a:Int,r:Int,g:Int,b:Int)
'?BigEndian
...
Type TPixmapLoaderTGA Extends TPixmapLoader
	...
	Method LoadPixmap:TPixmap( stream:TStream )
		Local	hdr:tgahdr		
		Local	w:Int,h:Int,tgatype:Int,bits:Int
		Local	buffer:Int[]
		Local	sbuffer:Short[]
		Local	bbuffer:Byte[]
		Local	i:Int,x:Int,y:Int,t:Int,a:Int
